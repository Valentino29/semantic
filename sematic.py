...
""" Found it interesting that banana to monkey was closer than banana to cat,
 that shows that when spacy does it's calculations a lot more details are involved than I thought"""

# My example

tokens = nlp("cat dog catnip bone tiger wolf ")
for token1 in tokens:
    for token2 in tokens:
        print(token1.text, token2.text, token1.similarity(token2))

""" This returned some unexpected results, according to this model cat is closer to wolf than tiger or
that dog is closer to catnip than bone, seems like it needs more information to run more precise"""
...
""" When Running simpler language model I have nboticed that accuracy of similarity decreses compared to 
running advanced language model"""